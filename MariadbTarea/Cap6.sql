...
#Se crea la tabla cornell_birds_families_orders
...
##ADVERTENCIA PARA INSETAR TODOS LOS DATOS DE ESTA TABLA CONSULTAR EL ARCHIVO ADJUNTO EN PDF
#INSERT INTO `cornell_birds_families_orders` VALUES (1,'Struthionidae (Ostrich)','Ostrich','Struthioniformes'),(2,'Struthionidae (Ostrich)','Ostrich (Common)','Struthioniformes'),(3,'Struthionidae (Ostrich)','','Struthioniformes'),(4,'Struthionidae (Ostrich)','','Struthioniformes'),(5,'Struthionidae (Ostrich)','','Struthioniformes');
